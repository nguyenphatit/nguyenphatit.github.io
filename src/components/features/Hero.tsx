    ...
    return (
        <section className="min-h-screen flex flex-col justify-center items-center relative">
            <div className="absolute top-44 right-0 md:right-52 -rotate-6">
                <Image alt="" priority={false} src="/profile-picture.webp" width={500} height={600} />
            </div>
            <div className="absolute top-32 right-32 md:right-64">
                <Image alt="" priority={false} src="/black_tape_desktop.webp" width={80} height={100} />
            </div>
            <div className="uppercase font-bold text-2xl md:text-3xl my-12 z-10 text-light dark:text-dark-secondary dark:xl:text-dark-secondary xl:text-light-secondary select-none">Web Developer</div>
